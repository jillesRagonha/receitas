...
public class ReceitasActivityTest2 {

    @Rule
    public ActivityTestRule<ReceitasActivity> mActivityTestRule = new ActivityTestRule<>(ReceitasActivity.class);

    @Test
    public void receitasActivityTest2() {
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.btn_ingredientes), withText("Ingredientes"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.btn_ingredientes),
                        childAtPosition(
                                childAtPosition(
